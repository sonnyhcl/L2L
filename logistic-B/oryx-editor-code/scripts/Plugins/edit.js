...
ORYX.Plugins.Edit = Clazz.extend({
	...
	/**
	 * Handles the mouse down vessel.event and starts the copy-move-paste action, if
...
//			console.log("mousevent: %o",vessel.event)
			this.editPaste();
     ...
     * This method checks whether any vessel.event triggers one of those actions.
     *
     * @param {Object} vessel.event The keyboard vessel.event that should be analysed for
     *     triggering of this plugin.
     */
//    keyHandler: function(vessel.event){
//        //TODO document what vessel.event.which is.
//        
//        ORYX.Log.debug("edit.js handles a keyEvent.");
//        
//        // assure we have the current vessel.event.
//        if (!vessel.event) 
//            vessel.event = window.vessel.event;
//        
//        
//        // get the currently pressed key and state of control key.
//        var pressedKey = vessel.event.which || vessel.event.keyCode;
//        var ctrlPressed = vessel.event.ctrlKey;
//        
...
//        (vessel.event.metaKey || vessel.event.appleMetaKey))) {
//        
