 ...
 */
package managerpart.activiti.conf;
...
@Configuration
@EnableJpaRepositories({"org.activiti.app.repository", "managerpart.repository"})
...
public class DatabaseConfiguration {
    ...
    public DataSource dataSource() {
        ...
        if (StringUtils.isNotEmpty(dataSourceJndiName)) {
            ...
            String dataSourceUrl = env.getProperty("datasource.url", "jdbc:h2:mem:manager;DB_CLOSE_DELAY=-1");
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        lcemfb.setPackagesToScan("org.activiti.app.domain", "vesselpart.*");
