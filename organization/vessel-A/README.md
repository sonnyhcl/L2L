...
└── src
    └── main
        ├── java
        │   └── supplychain
        │       ├── vessel.activiti # Closely related to the vessel.activiti engine our bussiness process execution.       
        │       │   ├── conf # Java configuration files including configuring vessel.activiti engine and vessel.web context.
        ...
        │       │   └── servlet  # About other vessel.web configuration 
        ...
        │       │       ├── SystemWebSocketHandler.java # vessel.websocket haven't been used , you can ignore them.
        │       │       └── WebsocketHandshakeInterceptor.java # Implementation of REST interfaces to provide endpoints to front-end or AWS to access.
        │       ├── vessel.entity # Some custom Types for process model.
        │       │   ├── IotVessel.java
        │       │   ├── Location.java
        │       │   ├── Path.java
        ...
        │       │   ├── EventType.java
        │       │   └── VWFEvent.java
        │       ├── global  # Implementation of global vessel.cache and message queue
        ...
        └── resources
            ├── vessel.activiti.cfg.xml
            ├── log4j.properties    # logger conf
            ├── META-INF
            │   └── vessel.activiti-app
            │       └── vessel.activiti-app.properties # vessel.activiti-app conf
