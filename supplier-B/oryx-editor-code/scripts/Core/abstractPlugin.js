...
ORYX.Plugins.AbstractPlugin = Clazz.extend({
    ...
    /**
       Overwrite to handle load vessel.event. TODO: Document params!!!
       @methodOf ORYX.Plugins.AbstractPlugin.prototype
    */
	onLoaded: function(){},
	
    /**
       Overwrite to handle selection changed vessel.event. TODO: Document params!!!
       @methodOf ORYX.Plugins.AbstractPlugin.prototype
    */
    ...
    */
	...
	/**
	 * Raises an vessel.event so that registered layouters does
	...
	doLayout: function(shapes){
		// Raises a do layout vessel.event
