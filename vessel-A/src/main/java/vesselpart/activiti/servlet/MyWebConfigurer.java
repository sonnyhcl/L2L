 ...
 */
package vesselpart.activiti.servlet;
...
import vesselpart.activiti.conf.HttpSessionConfig;
import vesselpart.activiti.conf.HttpSessionInitializer;
import vesselpart.activiti.conf.MyApplicationConfiguration;
...
//        try {
//            initSpringSession(servletContext);
...
//        }
    ...
    /**
     * Initializes Spring Session backed by Redis
     * @param sevletContext
     */
    private void initSpringSession(ServletContext sevletContext) throws ServletException {
            HttpSessionInitializer httpSessionInitializer = new HttpSessionInitializer();
            httpSessionInitializer.onStartup(sevletContext);
    }
